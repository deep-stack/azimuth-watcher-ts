...
export class Indexer implements IndexerInterface {
  ...
  async canSend (blockHash: string, contractAddress: string, _as: number, _point: number): Promise<ValueResult> {
    ...
    const contract = new ethers.Contract(contractAddress, abi, this._ethProvider);
    const value = await contract.canSend(_as, _point, { blockTag: blockHash });
  ...
  async getPool (blockHash: string, contractAddress: string, _point: number): Promise<ValueResult> {
    ...
    const contract = new ethers.Contract(contractAddress, abi, this._ethProvider);
    const value = await contract.getPool(_point, { blockTag: blockHash });
  ...
  async canReceive (blockHash: string, contractAddress: string, _recipient: string): Promise<ValueResult> {
    ...
    const contract = new ethers.Contract(contractAddress, abi, this._ethProvider);
    const value = await contract.canReceive(_recipient, { blockTag: blockHash });
